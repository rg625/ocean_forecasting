...
for root, dirs, files in os.walk(inDir):
    ...
    # handle individual simulation folders
        ...
        for fileName in sorted(files):
            ...
            if os.path.splitext(fileName)[1] in [".cfg"] or any(
                n in os.path.splitext(fileName)[0]
                for n in ["history", "restart_flow", "solution_flow"]
            ):
                ...
                if fileName == historyName:
                    with open(filePath, "r") as csvFile:
                        ...
                        for row in csvReader:
                            ...
                            if (
                                timeIter - historyReduceFrameNum[0]
                            ) % historyReduceFrameNum[1] == 0:
...
if render:
    ...
    for simDir in simDirs:
        ...
        vidfile = renderfile
        imageio.mimwrite(
            os.path.join(renderpath, vidfile),
            result,
            quality=10,
            fps=5,
