    ...
    def setup(self, model: Module, optimizer: Optimizer):
        ...
        layout["Training"] = {
            "Loss": [
                "Multiline",
                [
                    "_train/epoch_lossFull",
                ],
            ],
            "Loss Reconstruction": ["Multiline", ["_train/epoch_lossRec"]],
            "Loss Prediction": ["Multiline", ["_train/epoch_lossPred"]],
            "Comparison Rec vs 1. Pred Error": [
                "Multiline",
                ["_train/epoch_compRec1.Pred"],
            ],
            "Comparison 1. Pred vs Last Pred Error": [
                "Multiline",
                ["_train/epoch_comp1.LastPred"],
            ],
        }
        testNames = [
        ...
        for names in testNames:
            layout[names[0]] = {
                "MSE Reconstruction": [
                    "Multiline",
                    ["%s/epoch_lossRecMSE" % (names[1])],
                ],
                "MSE Prediction": ["Multiline", ["%s/epoch_lossPredMSE" % (names[1])]],
                "LSIM Reconstruction": [
                    "Multiline",
                    ["%s/epoch_lossRecLSIM" % (names[1])],
                ],
                "LSIM Prediction": [
                    "Multiline",
                    ["%s/epoch_lossPredLSIM" % (names[1])],
                ],
                "Comparison Rec vs 1. Pred Error": [
                    "Multiline",
                    ["%s/epoch_compRec1.Pred" % (names[1])],
                ],
                "Comparison 1. Pred vs Last Pred Error": [
                    "Multiline",
                    ["%s/epoch_comp1.LastPred" % (names[1])],
                ],
            }
...
class CustomSummaryWriter(SummaryWriter):
    def add_hparams(self, hparam_dict, metric_dict):
        ...
        for key, value in hparam_dict.items():
            ...
            elif type(value) not in [int, float, str, bool, torch.Tensor]:
                hparam_dict[key] = " "
