...
class LSiM_Base(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        LSiMBaseOutputs = namedtuple(
            "LSiMBaseOutputs", ["relu1", "relu2", "relu3", "relu4", "relu5"]
        )

        return LSiMBaseOutputs(h_relu1, h_relu2, h_relu3, h_relu4, h_relu5)
...
class LSiM_Skip(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        LSiMSkipOutputs = namedtuple(
            "LSiMSkipOutputs",
            ["relu1", "relu2", "relu3", "relu4", "relu5", "relu6", "relu7", "relu8"],
        )

        return LSiMSkipOutputs(con1, con2, con3, con4, dec3, dec2, dec1, con5)
...
class Squeezenet(torch.nn.Module):
    ...
    def forward(self, X):
        ...
        h = self.slice7(h)
        h_relu7 = h
        SqueezeOutputs = namedtuple(
            "SqueezeOutputs",
            ["relu1", "relu2", "relu3", "relu4", "relu5", "relu6", "relu7"],
        )

        return SqueezeOutputs(
