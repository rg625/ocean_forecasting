...
def main(config_path):
    ...
    clean_val_dir = processed_dir / "val_cleaned"
    clean_test_dir = processed_dir / "test_cleaned"
    ...
    process_ensemble_files(clean_test_dir, final_test_dir, "filter", filter_params)
